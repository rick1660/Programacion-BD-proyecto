...
--Alineación y balanceo, suspensión 03
  insert into Empleado(IdEmpleado,Nombre,Telefono,IdDepartamento,IdVehiculo) values(0323,'Diego Lopez',667357159,03,5);
...
--Mecánico 04
  insert into Empleado(IdEmpleado,Nombre,Telefono,IdDepartamento,IdVehiculo) values(0423,'Julio Calderon',664355412,04,2);
...
--Refaccionaria 05
  insert into Empleado(IdEmpleado,Nombre,Telefono,IdDepartamento,IdVehiculo) values(0523,'Saul Sandoval',667753211,05,3);
